...
const Users = () => {
    ...
    const { data: userData, isLoading } = useAllUsersQuery({ page, limit, email, role: "user" })
    ...
    return (
        <div className='p-10'>
            ...
            <div className='flex justify-end mb-5'>
                <input ref={emailRef} type="text" className='border my-auto py-1 px-3 w-72 rounded-lg border-primary/80' placeholder='Enter the userName' />
